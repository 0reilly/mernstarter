        ...
        <Routes>
          <Route path="/" element={
            <div className="bg-white shadow rounded-lg p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">Dashboard Placeholder</h2>
              <p className="text-gray-600">Replace this with your actual Dashboard component.</p>
            </div>
          } />
